...
import com.msfb.maju_mundur_application.service.JwtService;
...
public class JwtServiceImpl implements JwtService {
    ...
    public JwtServiceImpl(
            @Value("${maju_mundur.jwt.secret_key}") String jwtSecret,
            @Value("${maju_mundur.jwt.issuer}") String issuer,
            @Value("${maju_mundur.jwt.expiration-in-second}") long jwtExpiration
    ) {
