...
public class ErrorController {
    ...
    public ResponseEntity<CustomResponse<?>> responseExceptionHandler(ResponseStatusException e) {
    ...
    public ResponseEntity<CustomResponse<?>> dataIntegrityViolationExceptionHandler(DataIntegrityViolationException e) {
        CustomResponse.CustomResponseBuilder<Object> builder = CustomResponse.builder();
